...
public class TelaInicial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtTabacudo = findViewById(R.id.txtTabacudo);
        txtTabacudo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TelaInicial.this, TelaSignificado.class);
